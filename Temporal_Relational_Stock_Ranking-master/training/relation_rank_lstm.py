...
class ReRaLSTM:
    ...
    def train(self):
        ...
        with tf.device(device_name):
            ...
            outputs_proped = tf.matmul(weight_masked, seq_emb)
            if self.flat:
...
#Best Valid performance: {'mse': 0.0004946874234722308, 'mrrt': 0.03239652475623037, 'btl': 2.991293509112438}
#Best Test performance: {'mse': 0.0003785495184944894, 'mrrt': 0.03567767870436416, 'btl': 1.1422500174958259}