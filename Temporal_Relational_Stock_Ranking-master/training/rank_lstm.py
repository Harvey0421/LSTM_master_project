    ...
    def train(self):
        ...
        with tf.device(device_name):
            ...
            prediction = tf.keras.layers.Dense(units=1, activation=leaky_relu, name='reg_fc',
                  kernel_initializer=tf.compat.v1.glorot_uniform_initializer())(seq_emb)
...
#Best Valid performance: {'mse': 0.0004959676321596293, 'mrrt': 0.03349648484945336, 'btl': 2.5322516140295193}
#Best Test performance: {'mse': 0.00037937072406293116, 'mrrt': 0.031537290440409295, 'btl': 0.28488973621279}